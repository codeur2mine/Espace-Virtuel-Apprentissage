...
import { faHouseChimney, faUser, faUserAlt, faList, faDoorOpen, faComments, faDoorClosed, faFileWord, faMoneyBill, faEarth, faUsers } from '@fortawesome/free-solid-svg-icons';
        ...
        <div className="m-0 p-0 outline-none box-border block font-serif ">
            <div className="aside w-[14%] bg-[#fdf9ff] fixed flex justify-center border-r border-[#e8dfec] p-[1.5%] left-0 top-0 items-center z-[10] h-[100%]">
                ...
                <ul className="nav mt-[20%]">
                    ...
                    <Link to='/actualite'>
                        <li className="mb-[20px] block hover:text-[#22b35e] text-gray-500 hover:md:ml-[1rem] ease-in-out duration-300"><a href="#about" className="text-[16px] font-semibold block border-b border-[#e8dfec] p-[5px_15px] tracking-wider"><FontAwesomeIcon className="text-sm mr-[15px]" icon={faEarth}></FontAwesomeIcon> Actualité</a></li>
                    </Link>

                    <Link to='/communaute'>
                        <li className="mb-[20px] block hover:text-[#22b35e] text-gray-500 hover:md:ml-[1rem] ease-in-out duration-300"><a href="#about" className="text-[16px] font-semibold block border-b border-[#e8dfec] p-[5px_15px] tracking-wider"><FontAwesomeIcon className="text-sm mr-[15px]" icon={faUsers}></FontAwesomeIcon> Communauté</a></li>
                    </Link>
                </ul>
